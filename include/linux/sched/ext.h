...
enum scx_dq_id_flags {
	SCX_DQ_FLAG_BUILTIN	= 1LLU << 63,
	SCX_DQ_FLAG_LOCAL_ON	= 1LLU << 61,

	SCX_DQ_INVALID		= SCX_DQ_FLAG_BUILTIN | 0,
	...
	SCX_DQ_LOCAL_CPU_MASK	= 0xffffffffLLU,
};
...
struct sched_ext_ops {
	 ...
	 */
	s32 (*enqueue)(struct task_struct *p, u64 enq_flags);
